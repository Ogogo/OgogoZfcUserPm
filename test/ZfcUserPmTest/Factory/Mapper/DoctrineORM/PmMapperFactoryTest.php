...
namespace Ogogo\Zf2UserPmTest\Factory\Mapper\DoctrineORM;

use Ogogo\ZfcUser\Pm\Factory\Mapper\DoctrineORM\PmMapperFactory;
...
class PmMapperFactoryTest extends PHPUnit_Framework_TestCase
{
    ...
    /**
     * @covers Ogogo\ZfcUser\Pm\Factory\Mapper\DoctrineORM\PmMapperFactory::createService
     */
    public function testCreateService()
    {
        ...
        $this->assertInstanceOf('Ogogo\ZfcUser\Pm\Mapper\DoctrineORM\PmMapper', $result);
    }
}
