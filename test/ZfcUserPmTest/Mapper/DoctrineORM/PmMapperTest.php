...
namespace Ogogo\ZfcUserPmTest\Mapper\DoctrineORM;

use Ogogo\ZfcUser\Pm\Mapper\DoctrineORM\PmMapper;
use PHPUnit_Framework_TestCase;
use ZfcUser\Entity\User;
use Ogogo\ZfcUser\Pm\Entity\Conversation;
use Ogogo\ZfcUser\Pm\Entity\ConversationReceiver;
use Ogogo\ZfcUser\Pm\Entity\Message;
...
class PmMapperTest extends PHPUnit_Framework_TestCase
{
    ...
    /** @var \Ogogo\ZfcUser\Pm\Options\ModuleOptionsInterface */
    protected $options;
    ...
    public function setUp()
    {
        ...
        /** @var \Ogogo\ZfcUser\Pm\Options\ModuleOptionsInterface $options */
    ...
    /**
     * @covers Ogogo\ZfcUser\Pm\Mapper\DoctrineORM\PmMapper::__construct
     */
    public function testConstruct()
    {
        $this->assertInstanceOf('Ogogo\ZfcUser\Pm\Mapper\PmMapperInterface', new PmMapper($this->objectManager, $this->options, $this->zfcuserOptions));
    }

    /**
     * @covers Ogogo\ZfcUser\Pm\Mapper\DoctrineORM\PmMapper::getUsers
     */
    ...
    /**
     * @covers Ogogo\ZfcUser\Pm\Mapper\DoctrineORM\PmMapper::getUnreadConversations
     */
    public function testGetUnreadConversations()
    {
        ...
        $this->options->expects($this->once())
             ...
             ->will($this->returnValue('Ogogo\ZfcUser\Pm\Entity\ConversationReceiver'));

        $objectRepository = $this->getMock('Doctrine\Common\Persistence\ObjectRepository');

        $this->objectManager->expects($this->once())
                            ->method('getRepository')
                            ->with('Ogogo\ZfcUser\Pm\Entity\ConversationReceiver')
                            ->will($this->returnValue($objectRepository));
        ...
        foreach ($unreadConversations as $unreadConversation) {
            $this->assertInstanceOf('Ogogo\ZfcUser\Pm\Entity\ConversationInterface', $unreadConversation);
        }
    }

    /**
     * @covers Ogogo\ZfcUser\Pm\Mapper\DoctrineORM\PmMapper::getMessages
     */
    public function testGetMessages()
    {
        ...
        $this->options->expects($this->once())
             ...
             ->will($this->returnValue('Ogogo\ZfcUser\Pm\Entity\Message'));

        $objectRepository = $this->getMock('Doctrine\Common\Persistence\ObjectRepository');
        $this->objectManager->expects($this->once())
                            ->method('getRepository')
                            ->with('Ogogo\ZfcUser\Pm\Entity\Message')
                            ->will($this->returnValue($objectRepository));
        ...
        foreach ($messages as $message) {
            $this->assertInstanceOf('Ogogo\ZfcUser\Pm\Entity\MessageInterface', $message);
        }
    }

    /**
     * @covers Ogogo\ZfcUser\Pm\Mapper\DoctrineORM\PmMapper::markRead
     */
    public function testMarkRead()
    {
        ...
        $conversationReceive = $this->getMock('Ogogo\ZfcUser\Pm\Entity\ConversationReceiver');
        $objectRepository->expects($this->once())
                   ->method('findOneBy')
                   ->with($optionsData)
    ...
    /**
     * @covers Ogogo\ZfcUser\Pm\Mapper\DoctrineORM\PmMapper::getParticipants
     */
    ...
    /**
     * @covers Ogogo\ZfcUser\Pm\Mapper\DoctrineORM\PmMapper::getConversation
     */
    public function testGetConversation()
    {
        ...
        $this->options->expects($this->once())
             ...
             ->will($this->returnValue('Ogogo\ZfcUser\Pm\Entity\Conversation'));

        $objectRepository = $this->getMock('Doctrine\Common\Persistence\ObjectRepository');
        $this->objectManager->expects($this->any())
                            ->method('getRepository')
                            ->with('Ogogo\ZfcUser\Pm\Entity\Conversation')
                            ->will($this->returnValue($objectRepository));

        $conversation = $this->getMock('Ogogo\ZfcUser\Pm\Entity\Conversation');
        $objectRepository->expects($this->any())
                   ->method('find')
                   ->with('Ogogo\ZfcUser\Pm\Entity\Conversation', 1)
    ...
    /**
     * @covers Ogogo\ZfcUser\Pm\Mapper\DoctrineORM\PmMapper::getUserConversations
     */
    ...
    /**
     * @covers Ogogo\ZfcUser\Pm\Mapper\DoctrineORM\PmMapper::getLastReply
     */
    public function testGetLastReply()
    {
        ...
        $this->assertInstanceOf('Ogogo\ZfcUser\Pm\Entity\MessageInterface', $this->mapper->getLastReply($conversation));
    }

    /**
     * @covers Ogogo\ZfcUser\Pm\Mapper\DoctrineORM\PmMapper::markUnread
     */
    ...
    /**
     * @covers Ogogo\ZfcUser\Pm\Mapper\DoctrineORM\PmMapper::newMessage
     */
    public function testNewMessage()
    {
        ...
        $message = $this->getMock('Ogogo\ZfcUser\Pm\Entity\Message');
        ...
        $this->assertInstanceOf('Ogogo\ZfcUser\Pm\Entity\MessageInterface', $this->mapper->newMessage($conversation, $messageText, $user));
    }

    /**
     * @covers Ogogo\ZfcUser\Pm\Mapper\DoctrineORM\PmMapper::deleteConversations
     */
    ...
    /**
     * @covers Ogogo\ZfcUser\Pm\Mapper\DoctrineORM\PmMapper::isUnread
     */
...
//    /**
//     * @covers Ogogo\ZfcUser\Pm\Mapper\DoctrineORM\PmMapper::newConversation
//     */
