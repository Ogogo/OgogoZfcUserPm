...
namespace Ogogo\ZfcUser\Pm\Options;

use Zend\Stdlib\AbstractOptions;

class ModuleOptions extends AbstractOptions implements ModuleOptionsInterface
{
    protected $messageEntity = 'Ogogo\ZfcUser\Pm\Entity\Message';

    protected $conversationEntity = 'Ogogo\ZfcUser\Pm\Entity\Conversation';

    protected $conversationReceiverEntity = 'Ogogo\ZfcUser\Pm\Entity\ConversationReceiver';

    protected $pmMapper = 'Ogogo\ZfcUser\Pm\Mapper\DoctrineORM\PmMapper';
